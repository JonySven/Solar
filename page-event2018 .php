...
<head>
    ...
    <link rel="stylesheet" href=" <?php echo get_template_directory_uri() ?> /assets/css/page-event2018.css" />
...
<body>
    <header>
        ...
        <div class="coutner__data">
            ...
            <div class="data">
                <h1 class="data__title">КРЫМСКАЯ ОСЕНЬ <br> 2018</h1>
                <p class="data__subtitle">05.09.2018 - 08.09.2018</p>
            </div>
