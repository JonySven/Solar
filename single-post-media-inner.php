...
<head>
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/assets/css/page-media-inner.css" />
    ...
    <header>
            ...
            <div class="coutner__data">
                <div class="data">
                    ...
                    <p class="data__subtitle">25.09.2012 - 28.09.2012</p>
                </div>
    ...
    <main>
        ...
        <div class="main__wrap">
           ...
           <div class="banner">
            ...
            <section class="main_gallery_photo">

                <div class="contaiber__gallery">
               

                    <h2 class="contaiber__gallery_tittle"><?php the_title(); ?></h2>
                  
                    <div class="contaiber__gallery_photo">
                       
                            <p class=".main__wrap .main_gallery_photo .contaiber__gallery .contaiber__gallery_photo .item"><?php the_content(); ?></p>
                    </div>
                </div>
